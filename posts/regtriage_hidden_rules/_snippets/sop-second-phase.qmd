::: {.callout-note collapse="true" title="sop/v0.md in the second phase (311 words; Steps 4 and 5 are new)"}
````markdown
...
:::
::: {.callout-note collapse="true" title="sop/v_oracle.md in the second phase (970 words; Steps 7 and 8 state H4 and H5)"}
````markdown
# Regulatory triage procedure
