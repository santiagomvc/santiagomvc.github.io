...
<!--
Numbers quoted in the prose, each with its source. Tables, charts and snippets are
generated from final_run_data/ and the benchmark source by report/build.py and are not
listed here.

  37,073 documents; 305 dropped; train 17,897 / dev 50 / test 11,160 ... regbench/regtriage/README.md
  4 CFR titles, 9 agencies; judge mix 40/40/20; agent sonnet-5 medium, 20-call cap;
  learner opus-5, window 50, 5 edits ................................ regbench/regtriage/config.py, learner/propose.py
  run 01: 44% -> 92% (peak 94% at v2); H2, H3 100% from v1; H1 60-70%; v1 436 words, 3 edits ... summary.csv, 01/sop/v1.meta.json
  $115.67 over 3,000 episodes; $16.63 in two killed partial runs .... final_run_data/README.md, budget.json
  v0 exact 20% in runs 02-06; run 02: 20/18/20/20/20; H1-H3 at v4 90/100/100 ... summary.csv 02-*
  40 of 50 rejects were count rejects, 15 had nothing else wrong; 5 exemplars .... learner/propose.py
  forced 0 of 16, unforced 5 of 6; 16,000 vs 8,000 tokens ........... config.py, learner/propose.py
  run 03: exact 20/90/92/98/100, counts 100% from v1, ceiling 100 .... summary.csv 03-*
  run 07 (unpaid-turns branch, not a matrix row): exact 20/96/94/94/100 ... 07-think-h1234-unpaid-turns/curve.txt
  runs 03, 04, 06 wrote [A-Za-z]+ at v1 ............................... */sop/v1.md
  first edit matched gold in 4 of 5 unforced runs (03, 04, 06, 07 yes; 05 no) ... Table 3, curve.txt
  run 04 sentence 40/62/84/98/98; v3 exact 96% vs ceiling 86% ........ summary.csv 04-*
  questions bought 04: 3, 05: 3, 06: 4 ................................ */sop/v*.meta.json oracle_calls
  ceiling sentence 86/82/82 in runs 04/05/06 .......................... summary.csv
  run 06 v4 603 words, 86%, 79.0% penalized; run 04 v4 1,060 words, 94%;
  94 - 0.08*(1060/311-1)^2 = 47.6; ceiling 970 words, 46.1% ........... summary.csv, arithmetic
  run 05 applied 2/3/2/3 of 4/5/4/5; v4 34%, counts 40% ............... 05/sop/v*.meta.json, summary.csv
  judge kinds 7; oracle predicates ...................................... judge.py KINDS, oracle.py
  12 PRs merged 2026-09-12 ............................................ git log
-->
...
{{< include _snippets/sop-day-one.qmd >}}
...
Since the hidden SOP rules were relatively easy to learn, we expanded on two different avenues, making new harder tasks and adding constrains to the learning process.

{{< include _tables/t2.md >}}

{{< include _diagrams/day-two.qmd >}}
...
{{< include _snippets/sop-day-two.qmd >}}
...
Proposed changes in the day one version are absolute, which lacks the gradual improvement present in optimization techniques like gradient descent. Inspired by this need, we use `--lr` as the share of proposed edits a round applies. Run 05 uses 0.5; every other run applies every edit.
...
Given the limited time and cost constraints, only a few iterations were able to be completed, especially since the addition of H5 increased both time and cost. In addition to increasing the sample data and trying different seeds and models, it would be valuable to experiment on the learner sequential shape and different values of k and lr.

## Development experience

Here's a final more subjective note on the building process.

### Claude Code and Opus

Not having Fable 5.1 was a significant drag for this process, which was managed in a way with large Opus 5 capacity. The main problem with Opus 5 as a coding agent came in the beginning by giving it some of the liberty I tend to have with Fable. As a consequence, the first project draft with Claude had dozens of files and thousands of unnecessary lines of code.
...
After the initial project setup was completed, version control was included to keep track and simplify agentic code review. This was fundamental for iterating while keeping project stability and comparable results. However it brought some negative consequences in the development speed, given how new is the project and how much the ideas proposed affected the same paths of code. Though stacked diffs were used when possible, the time between merging and running comparable experiments on a similar setup took a toll that impacted the number of experiments available.
